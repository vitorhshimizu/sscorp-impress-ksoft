...
PUT UNFORMATTED
    ...
    "Creation DT;FSC/PEFC;Bez FSC/PEFC;Target Customer"
    SKIP .
...
FOR EACH ITEM NO-LOCK
    ...
    FOR EACH saldo-estoq NO-LOCK
        ...
        PUT UNFORMATTED
            ...
            ';' ""                          //Tare
            ';' IF AVAIL cst-prod THEN MAX(cst-prod.kg_bruto, cst-prod.kg_liquido) ELSE 0 //Gross Weith
            ...
            ';' IF AVAIL cst-prod THEN cst-prod.qt-folhas ELSE 0 //Qt in PSC
